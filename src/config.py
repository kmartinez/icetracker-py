...
# Rules: wake each 3hrs including the coms time hour. Breida 100 uses min=0 fjalls base 101 uses 30
COMMS_TIME = [13] #Final version should be 13
WAKE_UP_WINDOW_HRS  = [0, 3, 6, 9, 12, 13, 15, 18, 21]
# fjalls MINS=30 Breida 0
